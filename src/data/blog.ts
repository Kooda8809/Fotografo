...
export const blogPosts: BlogPostItem[] = [
  {
    slug: 'como-preparar-tu-sesion-newborn-en-zaragoza',
    ...
    content: [
      ...
      'El período idóneo para realizar este tipo de reportaje comprende entre el día 7 y el 14 de vida. Durante estas dos semanas, el bebé aún conserva la flexibilidad postural intrauterina y goza de ciclos de sueño profundo que facilitan posados cómodos y fisiológicamente respetuosos.',
      'En nuestro estudio ubicado en el Barrio del Actur en Zaragoza, todo el espacio está climatizado a una temperatura constante de entre 26 y 28 grados, acompañado de suave ruido blanco que recuerda al arrullo del vientre materno.',
      'Lo más importante es entender que en estas sesiones no hay prisas: respetamos cada toma de pecho o biberón, las pausas para cambiar el pañal y los ratitos de piel con piel necesarios para que el recién nacido se sienta siempre seguro y protegido.'
    ]
  },
  {
    slug: 'cuando-hacer-la-sesion-de-embarazo',
  ...
  {
    slug: 'por-que-celebrar-el-primer-cumpleanos-con-smash-cake',
    ...
    content: [
      ...
      'La sesión consta de tres fases maravillosas: primero realizamos retratos limpios en familia vestidos de fiesta; después presentamos la tarta artesanal para que el peque la toque, pruebe o destroce a su antojo; y por último disfrutamos de una bañerita vintage con agua tibia y burbujas.',
      'Cada detalle del decorado en nuestro estudio de Zaragoza se personaliza según la gama de colores o temática elegida, y trabajamos siempre con obradores locales de confianza que elaboran repostería apta para bebés.',
      'El resultado son fotografías espontáneas, llenas de color y frescura, perfectas para diseñar los recordatorios de cumpleaños y guardar la mejor sonrisa de su primera etapa de vida.'
    ]
  },
  {
    slug: 'guia-definitiva-para-fotos-de-comunion-en-zaragoza',
    ...
    content: [
      ...
      'Nuestra propuesta combina la elegancia del traje o vestido de ceremonia con toques de frescura contemporánea. Realizamos sesiones mixtas que pueden comenzar en nuestro estudio y continuar en preciosos parajes naturales de Zaragoza con la caída del sol.',
      'Planificar la sesión entre febrero y abril permite disponer con holgura de tiempo para el diseño e impresión de recordatorios, marcapáginas de algodón y álbumes encuadernados en lino artesanal antes del gran día.',
      'Nuestro mayor objetivo es que el protagonista disfrute de una tarde divertida donde pueda reír, correr y ser él mismo frente a la cámara sin presiones ni protocolos encorsetados.'
    ]
  },
  {
    slug: 'el-valor-incalculable-de-la-fotografia-familiar',
    ...
    content: [
      ...
      'Una sesión de fotografía de familia profesional detiene el tiempo. Captura el modo en que tu hijo te agarra la mano, la mirada de complicidad compartida con tu pareja y las risas cómplices que definen la cotidianidad de vuestro hogar.',
      'En Carlota Lagunas Fotografía cuidamos cada detalle: desde la asesoría de vestuario para coordinar tonalidades armoniosas hasta la entrega en cajas de madera grabadas y álbumes de autor pensados para durar más de cien años.',
      'Dentro de veinte o treinta años, estas fotografías serán el tesoro más preciado de tus hijos: una ventana viva al cariño incondicional con el que crecieron.'
    ]
  }
];
